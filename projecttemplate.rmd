...
ggplot(aes(TotalHours), data = sc) + 
  ...
  xlim(0, 1500)
```
The hours spent playing StarCraft 2 is left skewed with many outliers. Zooming into hour per week, we can see most players play between 0 to 35 hours a week. Zooming into total hours, most players are in the 0 to 1500 hours categories.
...
There are 3395 contributing players to this dataset with 
