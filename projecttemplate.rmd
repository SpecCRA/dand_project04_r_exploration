...
This data is also a snapshot of the overall skill levels for players at the time of data collection and for the specific expansion called Wings of Liberty. 
...
ggplot(aes(ComplexUnitsMade), data = sc) + 
  geom_histogram()
